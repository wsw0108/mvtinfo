...
pub struct Tile_Value {
    // message fields
    string_value: ::std::option::Option<::protobuf::Chars>,
...
impl Tile_Value {
    ...
    pub fn mut_string_value(&mut self) -> &mut ::protobuf::Chars {
        if self.string_value.is_none() {
            self.string_value = ::std::option::Option::Some(::protobuf::Chars::new());
        }
    ...
    pub fn take_string_value(&mut self) -> ::protobuf::Chars {
        self.string_value.take().unwrap_or_else(|| ::protobuf::Chars::new())
    }
...
impl ::protobuf::Message for Tile_Value {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_carllerche_string_into(wire_type, is, &mut self.string_value)?;
                },
                2 => {
...
pub struct Tile_Layer {
    ...
    keys: ::std::vec::Vec<::protobuf::Chars>,
...
impl Tile_Layer {
    ...
    // Param is passed by value, moved
    pub fn set_keys(&mut self, v: ::std::vec::Vec<::protobuf::Chars>) {
        self.keys = v;
    }

    // Mutable pointer to the field.
    pub fn mut_keys(&mut self) -> &mut ::std::vec::Vec<::protobuf::Chars> {
        &mut self.keys
    }

    // Take field
    pub fn take_keys(&mut self) -> ::std::vec::Vec<::protobuf::Chars> {
        ::std::mem::replace(&mut self.keys, ::std::vec::Vec::new())
    }

    pub fn get_keys(&self) -> &[::protobuf::Chars] {
        &self.keys
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_repeated_carllerche_string_into(wire_type, is, &mut self.keys)?;
                },
                4 => {
